...
namespace Ukraine.Services.Identity.Pages.ExternalLogin;
...
public class Callback : PageModel
{
	...
	private readonly SignInManager<UkraineUser> _signInManager;
	...
	public Callback(
		...
		SignInManager<UkraineUser> signInManager)
	{
	...
	private async Task<UkraineUser> AutoProvisionUserAsync(string provider, string providerUserId,
		IEnumerable<Claim> claims)
	{
		var sub = Guid.NewGuid().ToString();

		var user = new UkraineUser
		{
			Id = sub,
